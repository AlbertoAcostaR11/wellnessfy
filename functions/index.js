/**
 * Firebase Cloud Functions v2 - Wellnessfy
 * Usando firebase-functions v7+ con sintaxis v2
 */
 ...
 */
exports.fitbitProxy = onRequest({
    cors: ['https://app.wellnessfy.io', 'https://wellnessfy-app.web.app', 'http://localhost:8000']
}, async (req, res) => {
