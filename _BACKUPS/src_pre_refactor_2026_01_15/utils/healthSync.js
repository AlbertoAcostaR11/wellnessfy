...
export async function syncHealthData(startDate, endDate) {
    ...
    debugLog(`📥 Sincronizando desde: ${providerName}`, { startDate, endDate });
    ...
    try {
        ...
        debugLog(`📊 ${rawActivities.length} actividades obtenidas de ${providerName}`);

        // Normalizar datos usando el diccionario maestro
        const normalizedActivities = normalizeActivitiesData(rawActivities, providerName);
        ...
        return {
            ...
            todayMetrics: todayMetrics,  // <--- NUEVO
