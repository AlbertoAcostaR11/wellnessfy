...
import { getFirestore, doc, updateDoc, increment, addDoc, collection, getDocs, query, orderBy, limit, onSnapshot } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js';
...
export { app, auth, db, messaging, doc, updateDoc, increment, addDoc, collection, getDocs, query, orderBy, limit, onSnapshot };
