...
async function saveUserData() {
    try {
        ...
        if (AppState.currentUser && AppState.currentUser.id) {
            ...
            // We use updateDoc to only update changed fields if possible, 
            // but passing the whole object is fine for this structure size.
            await updateDoc(userRef, AppState.currentUser);
        }
    } catch (e) {
