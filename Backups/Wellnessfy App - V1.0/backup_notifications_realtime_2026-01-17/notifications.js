        ...
        <div class="space-y-6 animate-fade-in pb-10">
            ...
            <div class="flex flex-col gap-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-black tracking-tight bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
                            Notificaciones
                        </h1>
                        <p class="text-white/40 text-sm font-medium mt-1">Mantente al día con tu actividad</p>
                    </div>
