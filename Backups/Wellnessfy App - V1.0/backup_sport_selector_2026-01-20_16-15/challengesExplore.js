...
export const ExploreModule = {
    ...
    updateResults: function () {
        ...
        const filtered = this.mockGeoChallenges.map(c => {
            ...
            // Filtrar por deportes seleccionados (si hay selección)
            // Si activeSports está vacío, mostrar todos. Si no, debe incluir c.sport
            const sportMatch = this.activeSports.length === 0 || this.activeSports.includes(c.sport);
            return sportMatch && c.distanceKm <= this.radius;
