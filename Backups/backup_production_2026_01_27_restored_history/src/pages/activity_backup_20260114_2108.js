...
export function renderActivity() {
    ...
    return `
        ...
        <div class="flex gap-2 mb-6 relative z-40">
            ...
            >
                <span class="material-symbols-outlined text-lg mr-2 align-middle">sports</span>
                Mis Deportes
            </button>
        </div>
...
function renderResumenTab() {
    ...
    const stepsVal = stats.steps ? stats.steps.toLocaleString() : '--';
    const activeVal = stats.activeMinutes || '--';
    const caloriesVal = stats.calories ? stats.calories.toLocaleString() : '--';
    const heartVal = stats.heartRate || '--';
    ...
    return `
        ...
        <div class="grid grid-cols-2 gap-4 mt-2 mb-20">
            ...
            <div class="glass-card rounded-3xl p-6 bg-[#0f172a] border border-white/5 flex flex-col items-center justify-center gap-2 shadow-lg relative overflow-hidden">
                ...
                <p class="text-3xl font-bold text-[#ffb700]" id="valCalories">${caloriesVal}</p>
            ...
            <div class="glass-card rounded-3xl p-6 bg-[#0f172a] border border-white/5 flex flex-col items-center justify-center gap-2 shadow-lg relative overflow-hidden">
                ...
                <div class="flex items-center gap-2">
                    <p class="text-3xl font-bold text-white" id="valHeart">${heartVal}</p>
